...
public class ServoFs90rBlock extends TranslatorBlock {

	public ServoFs90rBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
